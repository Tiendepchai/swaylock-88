...
complete -c swaylock -l battery                     --description "Display the current battery percentage and charging status."
complete -c swaylock -l clock                       --description "Display a clock with the current time and date."
complete -c swaylock -l timestr                     --description "Format string for the time widget."
complete -c swaylock -l datestr                     --description "Format string for the date widget."
complete -c swaylock -l effect-blur                 --description "Apply a box blur approximation to the background."
complete -c swaylock -l effect-fade-in              --description "Fade in the background image over the given duration."
complete -c swaylock -l effect-pixelate             --description "Pixelate the background image."
complete -c swaylock -l indicator-anim              --description "Sets the animation style for the indicator."
complete -c swaylock -l indicator-anim-duration     --description "Sets the duration of the indicator animation in milliseconds."
complete -c swaylock -l indicator-anim-intensity    --description "Sets the intensity of the indicator animation."
complete -c swaylock -l screenshots            -s S --description "Use screenshots of the current outputs as the background image."
complete -c swaylock -l show-user                   --description "Display the current username."
